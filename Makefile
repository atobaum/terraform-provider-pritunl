build:
	go build -gcflags="all=-N -l" -o ~/.terraform.d/plugins/registry.terraform.io/atobaum/pritunl/0.0.1-pre/darwin_amd64/terraform-provider-pritunl_v0.0.1-pre main.go
